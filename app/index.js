...
client.on('ready', async () => {
  ...
  .setTitle("BOT ONLINE ログ")
     .setDescription(`BOT導入サーバー数:${client.guilds.cache.size}\nバックアップ可能ユーザー数:${totalMembers}人\nユーザー数:${client.users.cache.size}`)
...
async function refreshTokens() {
  ...
  fs.readFile(filePath, "utf8", async (err, data) => {
    ...
    const REDIRECT_URI = "https://honored-bronzed-harrier.glitch.me/callback";
    const headers = {
